    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            case "crear_gerente": 
                ...
                break; 
            case "crear_cajero": 
                request.getRequestDispatcher("/PagesCliente/CrearCajero.jsp").forward(request, response); 
                break; 
            case "crear_cliente": 
                 request.getRequestDispatcher("/PagesCajero/CrearCliente.jsp").forward(request, response); 
                break; 
            default: 
