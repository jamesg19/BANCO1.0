 ...
 * @author James
 */
@WebServlet("/reporteCC1PDF")
public class ExportarReporteCliente1 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
            ...
            List<Reporte1Cliente> Histo = gestor.reporte1Cliente(USER);
            
              
            File file = new File(request.getServletContext().getRealPath("/Resources/ReporteCliente/ReporteCliente1.jrxml"));
