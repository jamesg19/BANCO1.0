 ...
 * @author James
 */
@WebServlet("/reporteCC4PDF")
public class ExportarReporteCliente4 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=Reporte 4 Cliente .pdf");

            
            List<Reporte4Cliente> Histo = gestor.reporte4(USER);
            
              
            File file = new File(request.getServletContext().getRealPath("/Resources/ReporteCliente/Reporte4Cliente.jrxml"));
