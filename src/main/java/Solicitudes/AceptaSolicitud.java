 ...
 * @author james
 */
@WebServlet(name = "Aceptar", urlPatterns = {"/Aceptar"})
public class AceptaSolicitud extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("USER", USER);
                ...
                gestor2.accionSolicitud("ACEPTADO",ID);
                ...
                if ((solicitud != null)) {
                    ...
                    request.getRequestDispatcher("/PagesCliente/SolicitudRecibida.jsp").forward(request, response);
                } else {
                    request.getRequestDispatcher("/PagesCliente/SolicitudRecibida.jsp").forward(request, response);
                } 
        }
