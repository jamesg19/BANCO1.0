 ...
 * @author James
 */
@WebServlet(name = "Reporte_Gerente3", urlPatterns = {"/Reporte_Gerente3"})
public class Reporte_Gerente3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("LIMITE", limiteSuperior);
                ...
                if ((repo3 != null)) {
                    request.setAttribute("Reporte3", repo3);

                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte3.jsp").forward(request, response);
                } else {
                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte3.jsp").forward(request, response);
                }  
