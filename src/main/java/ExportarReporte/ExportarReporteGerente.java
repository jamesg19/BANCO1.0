 ...
 * @author James
 */
@WebServlet("/reporteG1PDF")
public class ExportarReporteGerente extends HttpServlet {

    
    GestorReporteGerente gestor = new GestorReporteGerente();
    Historial_Cambios histo = new Historial_Cambios();
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
            ...
            List<Historial_Cambios> Histo = gestor.historialCambiosL(tipo,USER);
            
            
            File file = new File(request.getServletContext().getRealPath("/Resources/ReportesGerente/Reporte1G.jrxml"));
