 ...
 * @author james
 */
@WebServlet(name = "Reporte_Gerente2", urlPatterns = {"/Reporte_Gerente2"})
public class Reporte_Gerente2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("t", tipo);
                ...
                repo2 = gestor.reporte2(limiteSuperior);

                if ((repo2 != null)) {
                    request.setAttribute("Reporte2", repo2);

                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte2.jsp").forward(request, response);
                } else {
                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte2.jsp").forward(request, response);
                }  
