 ...
 * @author James
 */
@WebServlet("/reporteG6PDF")
public class ExportarReporteGerente6 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=Reporte6 Gerente.pdf");

            
            List<Reporte2Gerente> Histo = gestor.reporte6(busqueda);
            
            
            File file = new File(request.getServletContext().getRealPath("/Resources/ReportesGerente/Reporte6Ge.jrxml"));
