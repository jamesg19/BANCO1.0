 ...
 * @author James
 */
@WebServlet(name = "Reporte_Gerente4", urlPatterns = {"/Reporte_Gerente4"})
public class Reporte_Gerente4 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("t", tipo);
                ...
                if ((repo4 != null)) {
                    ...
                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte4.jsp").forward(request, response);
                } else {
                    request.getRequestDispatcher("/PagesGerenteReporte/Reporte4.jsp").forward(request, response);
                }  
