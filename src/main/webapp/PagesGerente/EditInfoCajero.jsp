        ...
        <div class="container profile profile-view" id="profile">
            ...
            <form action="Actualizar_Usuario" method="POST" >
                ...
                <div class="form-row profile-row">
                    ...
                    <div class="col-md-8">
                        <h1 data-aos="fade-up-left">EDITAR INFORMACION DE UN CAJERO</h1>
                        <h5 data-aos="fade-up-left">A continuacion puedes editar la informacion de un cajero</h5>
                        <h5 data-aos="fade-up-left">ingresando el numero de DPI correcto</h5>
                        <hr>
                        <div class="form-row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group"><label>DPI *</label><input required="" value="<%=dpi%>" class="form-control" type="number" step="1" name="dpi"></div>
