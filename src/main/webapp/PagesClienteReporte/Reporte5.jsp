...
<%@page import="ReporteClass.Reporte4Cliente"%>
...
<html>
    ...
    <body align="center" >
        ...
        <%            
            ...
            ArrayList<Reporte4Cliente> cambios = null;
            cambios = (ArrayList<Reporte4Cliente>) request.getAttribute("Reporte5");
        %>       

        %>

        <form action="reporteCC5PDF" method="GET" >
            <br><!-- comment -->
            <br><!-- comment -->
            <br><!-- comment -->
            <br><!-- comment -->
            ...
            <div align="center" >
                ...
                <h4>Historial con el listado de solicitud de asociacion de cuenta realizadas con su estado</h4>
                <button  align="center" type="submit" class="btn btn-outline-danger">Exportar PDF</button>
            </div>
        </form>                    
