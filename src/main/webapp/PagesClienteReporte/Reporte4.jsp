...
<html>
    ...
    <body align="center" >
        ...
        <%            
            ...
            cambios = (ArrayList<Reporte4Cliente>) request.getAttribute("Reporte4");
        %>       

        %>

        <form action="reporteCC4PDF" method="GET" >
            <br><!-- comment -->
            <br><!-- comment -->
            <br><!-- comment -->
            <br><!-- comment -->
            ...
            <div align="center" >
                ...
                <h4>Historial con el listado de solicitud de asociacion de cuenta recibidas con su estado</h4>
