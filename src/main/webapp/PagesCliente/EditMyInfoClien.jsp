...
<html>
    ...
    <body>
        ...
        <%            String r = null;
            ...
            cumple = (String) request.getAttribute("Cumple");
                ...
                <div class="form-row profile-row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group"><label>Nombre *</label><input  value="<%=nombre%>" class="form-control" readonly="" type="text" name="nombre"></div>
                                <div class="form-group"><label>DPI *</label><input  value="<%=dpi%>" class="form-control" readonly="" type="number" step="1" name="dpi"></div>
                                <div class="form-group"><label>DIRECCION *</label><input  value="<%=direccion%>" readonly="" class="form-control" type="text"  name="direccion"></div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="selectbox">
