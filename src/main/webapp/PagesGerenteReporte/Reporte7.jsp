...
<html>
    ...
    <body align="center" >
        ...
        <%            String USER = null;
            ...
            ArrayList<Reporte7Gerente> cambios = null;
            cambios = (ArrayList<Reporte7Gerente>) request.getAttribute("Cliente");
        %>       
        <form align="center" action="Reporte_Gerente7" >
            <br>
            <br>
            <br>
            <br>
            <br>
            <h3 align="center" >Reporte 7</h3>
            <h5 align="center" >Cajero que mas transacciones ha realizado</h5>
        ...
        <table align="center" id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <form action="reporteG7PDF" method="GET" >
                <div align="center" >
                    <input value="<%=USER%>" class="form-control" type="hidden" name="USERR">
            ...
            for (Reporte7Gerente histo : cambios) { 
             c++;
            %>          
            <tr align="right">  
                ...
                <td><%=histo.getTotalTransaccion()%></td> 
            </tr>          
            <% }
                } else {%>
            <script>
